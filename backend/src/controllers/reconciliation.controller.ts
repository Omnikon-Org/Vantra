...
export const runReconciliation = async (req: Request, res: Response) => {
  try {
    ...
    const reconciliation = await ReconciliationService.run(tenantId, data);
...
export const manualMatch = async (req: Request, res: Response) => {
  try {
    ...
    const result = await ReconciliationService.manualMatch(tenantId, req.params.id as string, data);
...
export const deleteReconciliation = async (req: Request, res: Response) => {
  try {
    const tenantId = req.user!.tenantId;
    const result = await ReconciliationService.delete(tenantId, req.params.id as string);
